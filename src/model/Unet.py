...
class Spatialattention(nn.Module):
    # channel wise + depth wise attention (CBAM)
...
class CDUnet:
    # channel dependent unet
    # similar to the unet, but convolutions are channel dependent \
    # and condition with other channel only depends on spatial attention
    def __init__(
        self,
        dim,
        init_dim = None,
